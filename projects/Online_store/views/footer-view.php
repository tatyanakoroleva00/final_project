        ...
        <div class="container">
            <section class="footer-top">
                <div class="footer-column footer-column--left">
                    <p class="footer__logo">Domum Solatium
                    </p>
                </div>
                ...
                <div class="footer-column footer-column--right">
                    ...
                    <p class="bold-letters">We are here: <a href="#"><img alt="vk" src="icons/vk.png" class="vk"></a>
                ...
                <div class="footer-map">
                    <iframe src="https://yandex.ru/map-widget/v1/?ll=37.418055%2C55.983275&mode=usermaps&source=constructorLink&um=constructor%3A1463d499e0af37da61b58109a31b7585029bf0a3df9113857ae8ce55742fb42f&z=12"
                            width="300" height="150" frameborder="1" allowfullscreen="true" style="position:relative;">
                    </iframe>
                </div>
            </section>
        </div>
